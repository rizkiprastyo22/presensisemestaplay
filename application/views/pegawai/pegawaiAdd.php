    ...
    <div class="card">
      ...
      <div class="card-content">
        <form class="row" id="add-user-form" method="post" action="">
          ...
          <div class="input-field col s12 m6">
              <input id="username" name="id" type="text" value="<?php echo set_value('id'); ?>">
              <label for="id" class="">ID</label>
          </div>
          <div class="input-field col s12 right-align">
              <button type="submit" name="submit" value="add_pegawai" class="btn amber waves-effect waves-green">Simpan</button>
          </div>
        </form>
      </div>
    </div>
